                                   ...
                                   gpointer      marshal_data)
{
  ...
  GMarshalFunc_BOOLEAN__UINT64 callback;
  gboolean v_return;
...
void
__gst_app_marshal_ENUM__BOXED (GClosure     *closure,
                               GValue       *return_value,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
                               gpointer      marshal_data)
{
  typedef gint (*GMarshalFunc_ENUM__BOXED) (gpointer data1,
                                            gpointer arg1,
                                            gpointer data2);
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_ENUM__BOXED callback;
  gint v_return;
  ...
  callback = (GMarshalFunc_ENUM__BOXED) (marshal_data ? marshal_data : cc->callback);
...
void
__gst_app_marshal_BOXED__VOID (GClosure     *closure,
                               GValue       *return_value,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
