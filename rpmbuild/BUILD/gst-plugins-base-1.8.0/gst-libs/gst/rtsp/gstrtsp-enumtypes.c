...
gst_rtsp_header_field_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_HDR_RTCP_INTERVAL, "GST_RTSP_HDR_RTCP_INTERVAL", "rtcp-interval" },
...
gst_rtsp_status_code_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_STS_KEY_MANAGEMENT_FAILURE, "GST_RTSP_STS_KEY_MANAGEMENT_FAILURE", "key-management-failure" },
...
gst_rtsp_msg_type_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_MESSAGE_HTTP_REQUEST, "GST_RTSP_MESSAGE_HTTP_REQUEST", "http-request" },
      { GST_RTSP_MESSAGE_HTTP_RESPONSE, "GST_RTSP_MESSAGE_HTTP_RESPONSE", "http-response" },
...
gst_rtsp_range_unit_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_RTSP_RANGE_SMPTE_30_DROP, "GST_RTSP_RANGE_SMPTE_30_DROP", "smpte-30-drop" },
    ...
    GType g_define_type_id = g_enum_register_static ("GstRTSPRangeUnit", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_rtsp_trans_mode_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    ...
    GType g_define_type_id = g_flags_register_static ("GstRTSPTransMode", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
...
gst_rtsp_lower_trans_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GFlagsValue values[] = {
      ...
      { GST_RTSP_LOWER_TRANS_UDP_MCAST, "GST_RTSP_LOWER_TRANS_UDP_MCAST", "udp-mcast" },
    ...
    GType g_define_type_id = g_flags_register_static ("GstRTSPLowerTrans", values);
    g_once_init_leave (&g_define_type_id__volatile, g_define_type_id);
  }
  return g_define_type_id__volatile;
}
